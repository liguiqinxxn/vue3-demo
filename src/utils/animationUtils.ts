...
// AnimationManager 选项接口
export interface AnimationManagerOptions {
  position: Ref<number>
  itemWidthWithGap: Ref<number>
  loop: boolean
  visibleCount: number
  itemsCount: number
...
export class AnimationManager {
  private position: Ref<number>
  private itemWidthWithGap: Ref<number>
  private loop: boolean
  private visibleCount: number
  private itemsCount: number
  private actualItemsCount: number
  private containerWidth: Ref<number>
  ...
  smoothMove(targetPosition: number): void {
...
// AutoplayManager 选项接口
export interface AutoplayManagerOptions {
  autoplay: boolean
...
export class AutoplayManager {
  ...
  constructor(options: AutoplayManagerOptions) {
